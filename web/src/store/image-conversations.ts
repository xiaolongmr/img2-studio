...
function normalizeImageOutputFormat(value: unknown): ImageOutputFormat | undefined {
...
export function normalizeConversation(
    ...
    Array.isArray(conversation.turns) && conversation.turns.length > 0
      ...
      : [
          normalizeTurn({
            ...
            outputFormat: conversation.outputFormat,
  ...
  return {
    ...
    outputFormat: latestTurn.outputFormat,
